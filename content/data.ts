...
import dominca from "../assets/Dominica-passport.png";
import grenada from "../assets/grenada.jpg";
import lucia from "../assets/saint.jpeg";
...
const data = {
      ...
      values: [
        {
          ...
          image: lucia,
          subtitle:
            "Unlock the gateway to global freedom with Saint Lucia's Investment-based Citizenship.",
          description: {
            title: "Invest in Saint Lucia, Invest in Your Global Future",
            html: "<h2>ABOUT ST. LUCIA</h2> <p>St. Lucia has a stable political climate and a diverse economy that is fueled by tourism, agriculture, and financial services. The country is committed to sustainable development and has been investing in renewable energy and eco-tourism initiatives to ensure a more environmentally responsible future. With its vibrant culture, warm hospitality, and breathtaking scenery, St. Lucia is a captivating destination that is home to the very best that the Caribbean has to offer.</p> <p>&bull; &nbsp; &nbsp;The capital of the country is Castries</p> <p>&bull; &nbsp; &nbsp;The currency is the Eastern Caribbean dollar</p> <p>&bull; &nbsp; &nbsp;The current population as of 2021: 183,629</p> <p><br></p> <h3>CITIZENSHIP BY INVESTMENT PROGRAMME</h3> <p>To obtain citizenship in St. Lucia, applicants can either make a minimum donation of USD 100,000 to the National Economic Fund or invest a minimum of USD 200,000 in an approved real estate project.&nbsp;</p> <h3>BENEFITS</h3> <p>&bull; &nbsp; &nbsp;St. Lucia passport allows its holder to travel visa-free and visa-on-arrival to a total of 148 countries, including Singapore, Hong Kong, the United Kingdom, and the Schengen area.</p> <p>&bull; &nbsp; &nbsp;Citizenship is passed onto future generations; newborn children can be added as well.</p> <p>&bull; &nbsp; &nbsp;Applicants are exempt from the capital gains tax, foreign income tax, and inheritance tax.&nbsp;</p> <p>&bull; &nbsp; &nbsp;Applicants do not need to be in St. Lucia during the time of application.&nbsp;</p> <p>&bull; &nbsp; &nbsp;The process takes around 4 to 6 months.&nbsp;</p> <p>&bull; &nbsp; &nbsp;Access to European and offshore banking.</p> <p><br></p> <h3>PROGRAM REQUIREMENTS:</h3> <p>&bull; &nbsp; &nbsp;Applicant must have a clean criminal record.</p> <p>&bull; &nbsp; &nbsp;Applicants must successfully pass due diligence to proceed with the program</p> <p>&bull; &nbsp; &nbsp;Applicant must be in good health.</p> <p>&bull; &nbsp; &nbsp;It is not a requirement to reside in St. Lucia during the time of application.</p> <p>To qualify for the economic citizenship by investment programme, applicants may choose from one of the two options:</p> <p>&bull; &nbsp; &nbsp;Invest USD 100,000 as a non-refundable contribution to St. Lucia&apos;s National Economic Fund.</p> <p>&bull; &nbsp; &nbsp;Invest a minimum value of USD 200,000 in an approved real estate development.</p> <h3>APPLICATION PROCESS</h3> <p>The application process is straightforward, and it may take up to 6 months between initiating the process and receiving the residency documents. The application process can be divided into the following stages:</p> <p>Assessment &amp; Onboarding.</p> <p>&bull; &nbsp; &nbsp;Consult with Passport Legacy&rsquo;s client advisors.&nbsp;</p> <p>&bull; &nbsp; &nbsp;Passport Legacy&rsquo;s due diligence check is conducted.</p> <h3>Application Submission.</h3> <p>&bull; &nbsp; &nbsp;Client is on boarded and retainer fees are paid.</p> <p>&bull; &nbsp; &nbsp;Documents are prepared and application for St. Lucia is submitted.</p> <h3>Document &amp; Application Processing.</h3> <p>&bull; &nbsp; &nbsp;Application is processed.</p> <p>&bull; &nbsp; &nbsp;Government pre-approval is received.</p> <p>&bull; &nbsp; &nbsp;Investment requirements are fulfilled.&nbsp;</p> <h3>Approval &amp; Passport Handover.</h3> <p>&bull; &nbsp; &nbsp;Application is approved.&nbsp;</p> <p>&bull; &nbsp; &nbsp;Passport of St. Lucia is issued in 4-6 months.</p> <p>&bull; &nbsp; &nbsp;Passport is handed over to client by Passport Legacy&rsquo;s advisors.</p> <p><br></p> <p><br></p>",
        ...
        },
        {
          ...
          image: passport,
          subtitle:
            "A pioneering program in citizenship by investment, established since 1984.",
          description: {
            title:
              "Unlock Global Access with St. Kitts & Nevis Citizenship by Investment",
            html: "<h2>ST. Kitts and Nevis.</h2> <p>St. Kitts and Nevis, also known in its constitution as Saint Christopher and Nevis has been independent since 1983 and forms part of the group of islands known as the Lesser Antilles, located about 2000 km to the southeast of Miami, USA. The country borrowed its name from the famous Christopher Columbus.</p> <p>The financial services industry of St. Kitts and Nevis is being developed on the foundations set by new legislation passed for the registration of Companies, Foundations, Trusts, International Insurance and Trust Service Providers. It is expected that St. Kitts and Nevis will eventually take its place as a center for Offshore Services which will contribute significantly to the local economy in the future.</p> <h3>Investment Options:&nbsp;</h3> <p>Applicants can choose between two main investment options:</p> <p>&nbsp; &nbsp;a. Sugar Industry Diversification Foundation (SIDF): A donation to the SIDF, which supports the country&apos;s economic diversification efforts.</p> <p>&nbsp; &nbsp;b. Real Estate Investment: Invest in approved real estate projects, which typically require a minimum investment.</p> <p><br></p> <h3>SAINT KITTS CITIZENSHIP BY INVESTMENT REQUIREMENTS</h3> <p>In addition to making the necessary investment or donation there are several requirements that applicants must meet for Saint Kitts</p> <p><strong>Family Requirements</strong></p> <p>Family members can be included in the application for St Kitts citizenship. The main investor can include:</p> <p>&bull; &nbsp; &nbsp;Spouse</p> <p>&bull; &nbsp; &nbsp;Dependent Children</p> <p>&bull; &nbsp; &nbsp;Dependent Parents over 65 years</p> <p><strong>Due Diligence Requirements</strong></p> <p>All applicants will need to be of good character and undergo the St Kitts government&rsquo;s due diligence formalities: Investors must:</p> <p>&bull; &nbsp; &nbsp;Provide police reports &ndash; evidence of a clean criminal record</p> <p>&bull; &nbsp; &nbsp;Have no outstanding visa refusals</p> <p>&bull; &nbsp; &nbsp;Submit various documentation, including financial documents, employment/ business documents, ID, proof of address</p> <p>&bull; &nbsp; &nbsp;Attend a virtual interview</p> <p><strong>Minimum Stay Requirements</strong></p> <p>Saint Kitts Citizenship by Investment programme does not require applicants to meet any minimum stay requirements. Citizens of St Kitts will have the right to live, work or study in St Kitts and Nevis if they wish to, but this is not a pre-requisite of the programme. There is also no language test required.</p> <h3>HOW MUCH DOES ST KITTS CITIZENSHIP BY INVESTMENT PROGRAMME COST?</h3> <p>The lowest cost route to gain St Kitts Citizenship is via a donation to the Sustainable Island State Contribution Fund (SISC). The minimum investment required is currently $250,000 for a single applicant, $300,000 for couples, or $350,000 for a family of up to four people. Additional due diligence and processing fees are also applicable and will vary depending on the applicant&rsquo;s age and the size of their family.</p> <p><strong>St Kitts Citizenship by Real Estate Investment</strong></p> <p>Applicants can also gain citizenship in Saint Kitts and Nevis by investing in government-approved real estate developments, such as hotel resorts and touristic properties, by investing a minimum of $400,000 (resalable after 7 years) for each main applicant.&nbsp;</p>",
        ...
        },
        {
          ...
          image: grenada,
          subtitle:
            "Unlock global possibilities through a strategic investment in Grenada.",
          description: {
            title:
              "Elevate Your Global Standing with Grenada’s Citizenship by Investment",
            html: "<p>Grenada&rsquo;s Citizenship by Investment programme was introduced in 2013 and offers a low-cost entry for a second citizenship and passport. Applicants from all countries are welcome but are subject to strict due diligence checks. The programme attracts many high-net-worth investors from all over the world looking to increase their family&rsquo;s global mobility and obtain the security of a second citizenship in Grenada. Successful applicants will be granted Grenada citizenship, a certificate of naturalisation and a passport which will enable them to gain visa-free travel to more than 150+ countries worldwide.&nbsp;</p> <h2>Citizenship by Investment in Grenada</h2> <p>Several different nations offer Citizenship by Investment programmes, each setting its own requirements and costs to gain citizenship in the respective country. For Grenada, there are two avenues to secure Grenadian citizenship:&nbsp;</p> <ul > <li>The real estate option:&nbsp;</li> <li>One-time donation: contributing a significant donation to a government fund.</li> </ul> <p><strong>Requirements for Citizenship through Investment</strong></p> <p>To gain Grenada citizenship, an investor must fulfill several requirements in order to successfully complete the process:</p> <ul > <li>The main applicant must be 18 years old or older.</li> <li>The main applicant must prove that they have enough funds to make the required investment, and prove the legal source of these funds.</li> <li>The main applicant and dependents do not suffer from contagious diseases and/or serious health problems.</li> <li>Not to have been convicted in any country for any criminal &nbsp;offense.&nbsp;</li> <li>Not to be the subject of a financial crime investigation.</li> <li>Not to be considered a potential national security risk.</li> <li>Not to be involved in any activity likely to cause disrepute to Granada.</li> </ul> <p><strong>Documents Needed to Obtain Grenada Citizenship</strong></p> <p>To secure citizenship in Grenada, there are several documents you must have in order to successfully complete. If any of these documents are not provided, are incomplete, or are completed incorrectly, the application will not be accepted by &nbsp;Grenada&rsquo;s Citizenship by Investment Unit:</p> <ul > <li>Certified copy of ID Card</li> <li>Certified copy of passport</li> <li>Medical Certificate</li> <li>Original or Certified copy of Marriage Certificate (if applicable)</li> <li>Original or Certified copy of Birth Certificate (if applicable)</li> <li>Original Police Clearance Certificate</li> <li>Original Bank Reference Letter (Not older than 6 months)</li> <li>Six passport-size photos</li> <li>Statement of Source of Funds</li> <li>Photograph and Signature Certificate</li> <li>Affidavit of support for Dependents</li> <li>Investment Confirmation / Escrow agreement</li> <li>Proof of payment of nonrefundable processing and due diligence fees</li> <li>Official transcripts of written confirmation from a recognized education center (dependents over 18)</li> </ul> <p>*other documents may apply upon due diligence</p> <h3>Grenada Citizenship Benefits</h3> <ul > <li>Citizenship for life for the applicant making the investment and their family, as well as future generations.</li> <li>Efficient taxation allows the investor to grow their wealth through the investment they&rsquo;ve made.</li> <li>Dual citizenship is allowed</li> <li>No minimum stay is required to gain citizenship.</li> <li>Access to the E2 Visa of the USA.</li> </ul> <p>We at Range Developments have extensive experience guiding our investors through Grenada&rsquo;s CBI programme and have a productive and professional relationship with the government, adding greater efficiency to the process as we&rsquo;re a trusted CBI partner.</p>",
            slogan:
              "Turn Your Investment into Global Freedom with Grenada Citizenship",
          },
        },
        {
          id: "dominica",
      ...
      values: [
        {
          ...
          image: canadaCover,
          subtitle:
            "Elevate your educational journey in Canada's world-class academic institutions.",
          description: {
            title:
              "Unlock Educational Excellence with Canada's Study Visa Program",
        ...
        },
        {
          ...
          image: usa,
          subtitle:
            "Embark on an academic adventure in America's distinguished educational landscape.",
          description: {
        ...
        },
        {
          ...
          image: uk,
          subtitle:
            "Elevate your academic aspirations in the UK's world-renowned educational institutions.",
          description: {
        ...
        },
        {
          ...
          image: australia,
          subtitle:
            "Discover an Unparalleled Educational Experience in Australia’s Elite Institutions",
          description: {
            title:
              "Embark on an Academic Adventure with Australia’s Study Visa",
      ...
      values: [
        {
          ...
          id: "canada",
          subtitle:
            "Unveil the Splendors of Canada: From Scenic Landscapes to Cultural Richness",
          description: {
            title:
              "Step into the Majestic Wonders of Canada with a Tourist Visa",
        ...
        },
        {
          ...
          image: australia,
          subtitle:
            "Uncover Australia's Multifaceted Beauty: From Outback Wilderness to Cosmopolitan Elegance",
          description: {
            title:
              "Experience the Unforgettable Wonders of Australia with a Tourist Visa",
            ...
            slogan:
              "Adventure, Culture, and Natural Beauty: Australia Has It All",
          },
        },
        {
          ...
          image: uk,
          subtitle:
            "Unlock the Rich Tapestry of the UK: From Historic Landmarks to Modern Marvels",
          description: {
            title:
              "Discover the United Kingdom Like Never Before with a UK Visitor Visa",
        ...
        },
        {
          ...
          image: usa,
          subtitle:
            "Unveil the American Dream: From Coast to Coast, Discover the USA",
          description: {
            title:
              "Embark on the Ultimate American Adventure with a USA Tourist Visa",
            ...
            slogan:
              "Discover, Explore, Experience: Your Ultimate American Journey Awaits",
          },
        },
        {
          ...
          image: schengen,
          subtitle:
            "Unlock the Wonders of Europe: One Visa, 26 Countries, Endless Memories",
          description: {
            title:
              "Embark on a Grand European Odyssey with the Schengen Tourist Visa",
        ...
        },
        {
          ...
          id: "new-zealand",
          subtitle:
            "Your Passport to an Epic Adventure: Discover New Zealand's Untamed Beauty and Rich Culture",
          description: {
            title:
              "Discover the Untouched Paradise with New Zealand Tourist Visa",
            ...
            slogan:
              "Embark on a Journey to New Zealand: The Land of the Long White Cloud",
          },
        },
      ],
    },
  ...
  portugal: {
    ...
    hero: {
      ...
      description:
        "Discover the beauty of Portugal with ZeeVista Advisors. Our dedicated visa consultancy services make your Portuguese dreams a reality, ensuring a smooth journey to a land of rich history and vibrant culture.",
    },
    plans: {
      values: [
        {
        ...
        },
        {
          ...
          description: {
            ...
            slogan:
              "Unlock the Charm of Portugal's Serene and Vibrant Lifestyle with the Digital Nomad Visa",
          },
        },
      ],
    },
  ...
  canada: {
    ...
    hero: {
      title:
        "Unlock the Boundless Opportunities of Canada with Across the Globe",
      description:
        "Navigate the journey to your Canadian dream with Across the Globe. From skilled professionals to entrepreneurs, we guide you through Canada's diverse immigration pathways, ensuring a smooth transition to a land of unparalleled opportunities.",
    },
    plans: {
      values: [
        {
        ...
        },
        {
          ...
          description: {
            ...
            slogan:
              "Unlock Your Canadian Future with Provincial Nominee Programs",
          },
        },
        {
  ...
  australia: {
    ...
    hero: {
      title:
        "Embark on a New Journey in the Land Down Under with Across the Globe",
      description:
        "Explore the boundless opportunities Australia has to offer with Across the Globe. Catering to skilled professionals and aspiring entrepreneurs, we navigate you through the diverse Australian immigration pathways ensuring a seamless transition to a country brimming with potential.",
    },
    plans: {
      values: [
        {
  ...
  uk: {
    ...
    hero: {
      ...
      description:
        "Embark on your UK journey with the expertise of ZeeVista Advisors. With our unparalleled experience in immigration services, we make your UK dreams come true, be it in business or permanent residency.",
    },
    plans: {
      values: [
        {
          ...
          description: {
            title:
              "The UK Innovator Founder Visa: Your Pathway to UK Business Success",
        ...
        },
        {
          ...
          description: {
            title:
              "UK Expansion Worker Visa: Your Gateway to UK Business Growth",
        ...
        // },
        {
          ...
          description: {
            ...
            slogan:
              "Unveiling Prosperous Pathways with Entrepreneurial Self-Sponsorship",
          },
        },
      ],
    },
