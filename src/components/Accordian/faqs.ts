export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Immigration, driven by job opportunities, business, or family reunions, can be intricate. At ZeeVista Advisors, we're top Canada immigration consultants in Dubai, guiding you through challenges, supporting migration, offering investment opportunities, and assisting in educational choices. Whether you seek advice as USA immigration consultants in Dubai or need a UK visa consultant in Dubai, our expertise ensures a seamless journey through legal intricacies to achieve your migration goals.",
  },
  {
    id: 2,
    question: "Why do I need an immigration consultant?",
    answer:
      "An Immigration Consultant, like ZeeVista Advisors, is certified and continuously updated on migration rules and procedures. This ensures you receive accurate and timely visa advice, reducing the risk of oversights or errors that could jeopardize your application.",
  },
  {
    id: 3,
    question: "Can I apply for the process if I am not in UAE?",
    answer:
      "Absolutely. With ZeeVista Advisors, you can apply from any part of the world. Our global reach ensures that you get the best service, regardless of your location.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      "For a free visa assessment from ZeeVista Advisors, choose your desired visa type and then contact us either via phone at (00 971 4 449 0918) or email at Info.zeevistaadvisors.com. One of our experts will be in touch to guide you further.",
  },
  {
    id: 8,
