    ...
    <>
      ...
      <Routes>
        <Route path="/" element={<Layout />}>
          ...
          <Route
            path="/about-us"
            element={<AboutPage setProgress={setProgress} />}
          />
          <Route
            path="/contact"
            element={<ContactUsPage setProgress={setProgress} />}
          />
          ...
          <Route
            path="/immigration"
            element={<ImmigrationPage3 setProgress={setProgress} />}
          />
          <Route
            path="/immigration/:country/"
            element={<ImmigrationPage3 setProgress={setProgress} />}
          />
          <Route
          ...
          <Route
            path="/visit-visas"
            element={
              <DynamicPage country="visit-visas" setProgress={setProgress} />
            }
          />
          ...
          <Route
            path="/caribbean"
            element={
              <DynamicPage country="caribbean" setProgress={setProgress} />
            }
          />
          ...
          <Route
            path="/student-visas"
            element={
              <DynamicPage country="student-visas" setProgress={setProgress} />
            }
          />
