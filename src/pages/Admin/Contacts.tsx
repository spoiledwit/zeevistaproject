      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 mb-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-0">Manage Inquiries</h1>
            <button
              onClick={download}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:space-x-4">
            ...
            <div className="flex items-center space-x-4 w-full md:w-auto">
              <div className="bg-gray-100 px-4 py-2 rounded-md">
                ...
                <span className="ml-2 text-sm font-bold text-gray-900">{filteredInquiries.length}</span>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="bg-gray-100">
                    ...
                    <th className="px-3 py-3 text-left text-sm font-semibold text-gray-600">Email</th>
                    <th className="px-3 py-3 text-left text-sm font-semibold text-gray-600">Phone</th>
                    <th className="px-3 py-3 text-left text-sm font-semibold text-gray-600">Job Title</th>
                    <th className="px-3 py-3 text-left text-sm font-semibold text-gray-600">Education</th>
                    <th className="px-3 py-3 text-left text-sm font-semibold text-gray-600">Nationality</th>
                    <th className="px-3 py-3 text-left text-sm font-semibold text-gray-600">Text</th>
                    <th className="px-3 py-3 text-left text-sm font-semibold text-gray-600">Created At</th>
                  </tr>
                </thead>
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredInquiries.map((inquiry, index) => (
                    <tr key={index} className="hover:bg-gray-50 transition-colors duration-150">
                      <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{inquiry.name}</td>
                      <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-600">{inquiry.email}</td>
                      <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-600">{inquiry.phone}</td>
                      <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-600">{inquiry.jobTitle}</td>
                      <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-600">{inquiry.education}</td>
                      <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-600">{inquiry.nationality}</td>
                      <td className="px-3 py-4 text-sm text-gray-600 max-w-xs truncate">{inquiry.text}</td>
              ...
              {filteredInquiries.length === 0 && (
                <p className="text-center text-gray-500 py-8 text-base">No inquiries found.</p>
              )}
            </div>
          </div>
        )}
