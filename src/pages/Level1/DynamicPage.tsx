...
const DynamicPage: React.FC<Props> = ({ setProgress, country }) => {
    ...
    <div className="w-full  min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage:
            country === undefined
              ? `url(${img})`
              : `url(${countries.filter((c) => c.name === country)[0].image})`,
      ...
      >
        ...
        <div className="flex flex-col w-full h-full justify-center mt-20 z-10">
          ...
          <span className="text-white text-xl text-justify mb-12">
