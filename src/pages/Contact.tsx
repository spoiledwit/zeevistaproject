...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen pb-32 bg-white relative">
      <Hero />
      <div className="flex md:flex-row flex-col w-full pt-10  justify-between px-8 md:px-20">
